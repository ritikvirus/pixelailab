# --- START OF Download_models_GGUF_PHANTOM.py ---
...
def main():
    ...
    print("Starting Phantom Wan GGUF model downloads...")
    ...
    print("- Requires WanVideoWrapper ComfyUI custom node")
...
# --- END OF Download_models_GGUF_PHANTOM.py ---